...
const skip = enabled ? false : `set ARCHIE_E2E_PUBLISHED_CONTEXT=1 to resolve the eight-skill Archie context from the packages/archie-context subfolder of git@github.com:don-smith/archie.git at the fixture's pinned commit (requires SSH access); see context/03-delivery/guides/release-bundle-operations.md`;
