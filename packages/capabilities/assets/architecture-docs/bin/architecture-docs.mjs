...
async function runConfiguredSkill(commandArgs) {
  ...
  if (!config.skillCommand) {
    console.error(`No skillCommand override is configured for target root ${process.cwd()}. Use the target-local default: npx --no-install architecture-docs ${subcommand}.`);
    return 1;
  }
