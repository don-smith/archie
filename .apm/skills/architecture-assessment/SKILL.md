...
1. Inspect repository-local instructions, the supplied artifact, and its linked intent, design, research, glossary, decision, and architecture sources.
2. Then the supplied artifact, its `workstream.md`, and linked intent, design, research, glossary, decision, and architecture sources.
