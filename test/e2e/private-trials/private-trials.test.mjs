...
test("private-trial evaluation proves the integrated v2 release-candidate matrix", () => {
  ...
  try {
    ...
    assert.equal(evidence.format, "archie-private-trial-evidence-v2");
    ...
    assert.equal(evidence.v1ToV2Upgrade.passed, true);
    ...
    assert.equal(evidence.integrity.skillCount, 6);
