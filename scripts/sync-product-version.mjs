...
const workspaceManifests = ["packages/archie-runtime/package.json", "packages/archie-cli/package.json", "packages/archie-context/package.json", "packages/capabilities/package.json"];
